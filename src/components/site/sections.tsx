        ...
        <Reveal delay={180}>
          <div className="glass-card journal-dots p-5">
            ...
            <ul className="mt-4 space-y-2">
              {["present", "presence", "presenting", "presentation"].map((opt, i) => (
                <li key={opt}>
                  <div
                    className={cn(
            ...
            <p className="mt-4 rounded-xl bg-muted/70 p-3 text-xs leading-relaxed text-muted-foreground">
              Ghi chú: sau trợ động từ <b>will</b> cần động từ nguyên thể — chọn “present”.
            </p>
          </div>
        </Reveal>
      </div>
    ...
    <Section id="roadmap">
      <div className="grid gap-8 lg:grid-cols-[1fr_0.8fr] lg:items-center">
        ...
        <Reveal delay={120}>
          <img
            src={MASCOT.plan}
            alt="Oysteic cầm bảng kế hoạch học tập"
            loading="lazy"
            className="animate-float-soft mx-auto w-52 drop-shadow-2xl sm:w-64"
          />
        </Reveal>
      </div>
